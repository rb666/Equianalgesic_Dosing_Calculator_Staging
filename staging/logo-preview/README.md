...
- The source calculator in `public/`, clinical tables, provenance digest, and approved fixtures are unchanged. Production calc.med and the original/base repository remain outside this release.
